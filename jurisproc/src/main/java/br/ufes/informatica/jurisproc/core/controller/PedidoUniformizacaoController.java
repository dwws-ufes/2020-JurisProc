...
public class PedidoUniformizacaoController extends JSFController {
	...
	/** Getter for anexoPeticao. */
	public Part getAnexoPeticao() {
		return anexoPeticao;
	}

	/** Setter for anexoPeticao. */
	public void setAnexoPeticao(Part anexoPeticao) {
		this.anexoPeticao = anexoPeticao;
	}
